...
export const posts = [
  {
    ...
    postImage:
      "https://quizizz.com/media/resource/gs/quizizz-media/questions/27fffd9d-f874-4383-a55b-79e5a557248e?w=90&h=90",
    content:
  ...
  },
  {
    ...
    postImage:
      "https://media.istockphoto.com/photos/doctor-with-medical-healthcare-icon-interface-picture-id949812138?k=20&m=949812138&s=612x612&w=0&h=zQKckR3bFo8M_D5CsOAHwlPyTHo5r51UsyO6t-ilZdQ=",
    content:
  ...
  },
  {
    _id: uuid(),
    title:
      "The Best Glucometer in India - ACCU-CHEK ACTIVE GLUCOMETER KIT (WITH FREE 10 STRIPS)",
    postImage:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQmq9v5_jMBiTB7Z_z7ZcH_bGPrpDbytgMK1Q&usqp=CAU",
    content:
    ...
    createdAt:  new Date("2-02-2022").toLocaleString()
    // updatedAt: formatDate(),
  },
  {
    _id: uuid(),
    ...
    postImage:
      "https://i0.wp.com/images-prod.healthline.com/hlcmsresource/images/topic_centers/idiopathic-pulmonary-fibrosis/1296x728_5_Ways_to_Keep_Your_Lungs_Healthy_and_Strong.jpg?w=1575",
    content:
  ...
  },
  {
    ...
    postImage:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRJXlTTJJMp8QcJnSCPr9_0jZZorAr2a_vsdg&usqp=CAU",
    content:
    ...
    comments: [],
    bookmark: [],
    createdAt: new Date("4-02-2022").toLocaleString()
    // updatedAt: formatDate(),
  },
  {
    _id: uuid(),
    ...
    postImage:
      "http://caresathome.in/wp-content/uploads/2019/06/foods_to_avoid_in_diabetes-1080x675.jpg",
    content:
  ...
  },
  {
    ...
    postImage:
      "https://blog.medplusmart.com/wp-content/uploads/2019/10/Foods-to-Eat-on-Empty-Stomach.jpg",
    content:
    ...
    comments: [],
    bookmark: [],
    createdAt: new Date("10-02-2022").toLocaleString()
    // updatedAt: formatDate(),
  },
  {
    _id: uuid(),
    ...
    postImage:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSFLC9b7GBxMfl8t9LE4jj4ohjBSttXusXYLw&usqp=CAU",
    content:
  ...
  },
  {
    ...
    postImage:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRDiQ77VjxIGHBxY-3TtFZwiCl6DMGYVjc9ow&usqp=CAU",
    content: "",
    likes: {
      likeCount: 0,
      likedBy: [],
  ...
  },
  {
    ...
    postImage:
      "https://www.rcpjournals.org/content/clinmedicine/13/3/244/F1.large.jpg?width=800&height=600&carousel=1",
    content:
